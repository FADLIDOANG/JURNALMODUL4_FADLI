...
<div class="bg-white p-6 rounded shadow mb-4">
    <h1 class="text-3xl font-semibold text-gray-800 mb-2">Artikel Saya</h1>
    <p class="text-gray-700 mb-6">Kelola artikel yang Anda buat — buat, edit, atau hapus sesuai kebutuhan.</p>

    <div class="mb-4">
        <a href="{{ route('mahasiswa.create') }}" class="bg-blue-600 text-white py-2 px-6 rounded-full shadow hover:bg-blue-700 transition duration-200">
            Buat Artikel Baru
        </a>
    </div>
</div>
            ...
            <div class="relative bg-white p-4 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition duration-200 group">
                ...
                <div class="flex justify-between items-center mt-4 relative z-10">
                    ...
                    <div class="flex space-x-4">
                        <a href="{{ route('mahasiswa.edit', $article) }}" class="text-blue-600 hover:underline z-20">Edit</a>
                        <p>|</p>
                        <form action="{{ route('mahasiswa.destroy', $article) }}" method="POST" class="inline z-20">
                            @csrf
                            @method('DELETE')
