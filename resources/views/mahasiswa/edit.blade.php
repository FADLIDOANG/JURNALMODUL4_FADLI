...
<div class="container mx-auto p-6">
    ...
    <form action="{{ route('mahasiswa.update', $article->id) }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow-lg">
        @csrf
        @method('PUT')
        ...
        <div class="flex justify-start items-center mt-6 p-2 space-x-4">
            <a href="{{ route('mahasiswa.index') }}" class="bg-gray-300 text-gray-800 px-6 py-2 rounded-full hover:bg-gray-400 transition duration-300">
                Kembali
            </a>
